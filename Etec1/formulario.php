<?php
// Página que processa o formulário e mostra a maldita mensagem
$mensagem = "";
$tipo = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (empty($msg)) {
        ...
        // guardar no futuro
        //futuramente testar um banco e tentar usar um email
        // por enquanto, só exibe a mensagem de sucesso :(
    }
} 
else {
    // se por algum acaso algm acessar diretamente o formulário sem passar pela página de contato
...
<body>
    <div class="box <?php echo $tipo; ?>">
        <?php if ($tipo == "sucesso"): ?>
            ...
            <h2>Mensagem Enviada com sucesso, aguarde a resposta!</h2>
            <p><?php echo $mensagem; ?></p>
            <a href="contato.html" class="btn">Voltar para o Contato</a>
            
        <?php else: ?>
            <i class="fas fa-exclamation-triangle"></i>
            <h2>Algo deu errado, verifique as informações.</h2>
            <p><?php echo $mensagem; ?></p>
